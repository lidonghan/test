...
#elif defined(CONFIG_BCM4330) || defined(CONFIG_BCM4329) || defined(CONFIG_BCM4319) || defined(CONFIG_RKWIFI) || defined(CONFIG_RTL8189ES)
	#define RK30SDK_WIFI_GPIO_POWER_N               RK30_PIN3_PD0                 
...
int rk31sdk_get_sdio_wifi_voltage(void)
{
    ...
    ******************************************************************************/
#if defined(CONFIG_BCM4330) || defined(CONFIG_BCM4329) || defined(CONFIG_BCM4319) || defined(CONFIG_RKWIFI)
